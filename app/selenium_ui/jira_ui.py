...
def test_1_selenium_custom_action_pivotchart(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_pivotchart(jira_webdriver, jira_datasets)

def test_1_selenium_custom_action_planchart(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_planchart(jira_webdriver, jira_datasets)
